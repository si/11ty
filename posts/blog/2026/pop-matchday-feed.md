...
I mocked this one up properly rather than scribbling it on paper. The bit I kept coming back to is the listener experience: same episode, same feed, completely different depending on when you open it. Mid-match it's streaming, sats ticking up as people tip the commentator. By full-time it's quietly become an on-demand replay, no separate archive, no re-upload, the feed item just changes state under you.
