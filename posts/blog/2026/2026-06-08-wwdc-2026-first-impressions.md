...
Apple's WWDC 2026 keynote just wrapped from Apple Park, and I watched the whole thing live. As ever, there's a mix of "finally" and "we'll see about that". Here are my unfiltered first impressions while it's still fresh.
...
3D views are getting better. My question, as always: does any of it work in CarPlay? That's where I'll actually use Maps. If it doesn't hold up at 70mph on the motorway, it doesn't really count for me.
...
**Dedicated Siri app.** Finally. History, context, and hopefully the ability to repurpose previous threads. This has been a glaring omission for too long.
...
**Message action suggestions.** Happy wife, happy life.

**Natural language calendar events.** Something for [PETALS](https://petals.team) to think about with scheduling.

---

## Home

Home assistant with camera integration. You'd need quite a setup around the house for this to really sing. Possibly a few cameras too many.
