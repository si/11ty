...
Presented by Andy "[Malarkey](http://twitter.com/Malarkey)" Clarke and [Anna Debenham](http://twitter.com/anna_debenham), this podcast focusses on the unspoken world of business. It seems to be a taboo subject in the open web community but Andy and Anna address the topic with their own experiences and in their own special way.
...
[Sarah Parmenter](http://twitter.com/sazzy) had a Eureka moment last year that we need to inject some inspiration and cheer into the humdrum start of the week so took it upon herself to release a short, 30 minute chat show about the web design industry. Teaming up with [Josh Long](http://twitter.com/joshlong), they introduce guests to their weekly show who all have something inspirational to contribute.
...
Hosted by [Keir Whitaker](http://twitter.com/keirwhitaker) and [Kieran Masterton](http://twitter.com/kieranmasterton), this podcast takes a wider look at the Web, drawing on topical content such as conferences, emerging technology and techniques and much more. With such wisdom between the two of them, expect some insightful thoughts into the industry.
