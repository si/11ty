---
title: "Encourage faster feedback for personal improvement with Speedback"
date: 2022-01-12
categories: 
  - "blog"
tags: 
...
- Annual reviews often seek peer/360 feedback to support the self-reflection with external thoughts and opinions but it can be _painful_ to get any responses.

### A solution

I caught wind of a ‘_speedback’_ concept last Summer which creates a **speed**\-networking environment but focused on personal **feedback** (hence the puntastic wordplay).
...
**_Speed-networking_** + **faster feedback** = **Speedback**
...
3. Once you know who’s attending, create a schedule for each possible pair. I used [Fixture List](https://www.fixturelist.com/createlist) — choose **Player** participant type and **Once Only** meetings, enter all the names and generate the schedule.
