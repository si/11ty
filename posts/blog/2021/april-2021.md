...
- Encouraging and facilitating everyone to make the most of our revived monthly day of learning (known as _Tech Develops_), helped along with a little order of Moo stickers to motivate some engineers sharing their knowledge at the end of the day.
...
- [#FinesseFriday](bear://x-callback-url/open-tag?name=FinesseFriday) has continued to engage with the subscribers and listeners as weekly download counts seem to be growing week on week, thanks to a [guest mix from Ben Hedley](https://www.housefinesse.com/finessefriday/featuring-ben-hedley/), an [adhoc session from LYP](https://www.housefinesse.com/finessefriday/finessefriday-lyp-goes-deep/) and some great fan selections from the archives 
- With [#FinesseFriday](bear://x-callback-url/open-tag?name=FinesseFriday) gaining traction and listening back to the archives, I decided to re-register [funkyhousefinesse.com](http://funkyhousefinesse.com) for anyone who tried to find them. For now, it’s just redirecting to the archives list but there’s lots of audio content that needs restoring from my backups. 
- In preparation for the upcoming EURO 2020 competition, I’ve started to build another football calendar platform with the inspired name [FootballCal](http://footballcal.com). Focus is on MVP with rapid iterative releases; content is already published but the design needs desperate attention with new features and improvements planned on [the Trello backlog](https://trello.com/invite/b/KYdByEKj/8ca5511ce5b058b6bbf0f7612636085d/football-cal-%E2%9A%BD%EF%B8%8F)
- [Time Journal](https://docs.google.com/spreadsheets/d/1BVByO-ElCUT5CIB6pI-lbWlOe9GlkAv9bAR5safBh48/edit?usp=sharing) needs some love. I’ve been meticulously recording my half hour units for several months now but really need to revisit what I’m trying to measure and work out how to get that. 
- Whilst sitting around in hospital, I took the chance to review the content on Mrs J’s young adult novel website, [Astral Lariat](https://unstyled.com/astral-lariat/) - only minor updates but a good reason to keep the domain handy for when she finally has something to publish and share. 

## **Entertainment** 

Some TV highlights from the past month include:

- [White House Farm](https://www.netflix.com/watch/81189149?source=35) on Netflix
- [Behind Her Eyes](https://www.netflix.com/watch/80244630?source=35) on Netflix
- [Star Struck](https://www.bbc.co.uk/iplayer/episodes/p09djx02) on iPlayer 
- [The Flight Attendant](https://www.nowtv.com/watch/the-flight-attendant/iYEQZ1vXy2NqkXEvdXuAJC) on Sky Atlantic (NowTV)
